...
const Map<String, int> towerRanges = const {'pellet': 100, 'fireball': 75, 'flamethrower': 50};
const Map<String, double> towerCooldowns = const {
  'pellet': 1.0,
  'fireball': 2.0,
  'flamethrower': 0.2,
};
const Map<String, int> towerCosts = const {'pellet': 50, 'fireball': 75, 'flamethrower': 100};
const Map<String, int> bulletDamage = const {'pellet': 1, 'fireball': 5, 'flamethrower': 1};
